...
// Consulta para obter os títulos e descrições dos treinos usando prepared statement
$selectQuery = "SELECT titulo, descricao FROM treinos WHERE iduser = ? ORDER BY id_treino DESC";
...
if ($stmt) {
    ...
    if ($result) {
        // Exibir os títulos e descrições dos treinos

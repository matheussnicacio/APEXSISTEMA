...
body {
    width: 100%;
    overflow-x: hidden; /* Isso pode ajudar a ocultar a barra de rolagem horizontal */
}
  ...
  <body>
    <header>
      <nav>
        ...
        <a href="../php/home.php">
          <a href="../php/home.php" class="profile-icon">
            <?php
              ...
              $select_image = mysqli_query($conn, "SELECT image FROM `user_form` WHERE iduser = '$user_id'") or die('query failed');

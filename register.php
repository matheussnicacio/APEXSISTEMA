...
if(isset($_POST['submit'])){
   ...
   $name = mysqli_real_escape_string($conn, $_POST['nome_cli']);
   ...
   if(mysqli_num_rows($select) > 0){
      ...
      if($pass != $cpass){
         ...
         $insert = mysqli_query($conn, "INSERT INTO `user_form`(nome_cli, email, password, image) VALUES('$name', '$email', '$pass', '$image')") or die('query failed');
...
<div class="form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      ?>
      <input type="text" name="nome_cli" placeholder="Username" class="box" required>
